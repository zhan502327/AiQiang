...
//改造前
//- (void)configWithRedpacketMessageModel:(RedpacketMessageModel *)redpacketMessage andRedpacketDic:(NSDictionary *)redpacketDic;
//改造后
- (void)configWithRedpacketMessageModel:(RedpacketMessageModel *)redpacketMessage andRedpacketDic:(NSDictionary *)redpacketDic andIsDBSender:(BOOL)isDBSender;
