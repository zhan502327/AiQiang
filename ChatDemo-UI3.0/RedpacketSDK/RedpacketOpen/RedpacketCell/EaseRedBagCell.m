...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    if (messageModel.redpacketType == RedpacketTypeAmount) {
        ...
        RedpacketMessageModel *dbModel = [RedpacketMessageModel redpacketMessageModelWithDic:model.message.ext];
//        [_redpacketView configWithRedpacketMessageModel:dbModel andRedpacketDic:model.message.ext];
        [_redpacketView configWithRedpacketMessageModel:dbModel andRedpacketDic:model.message.ext andIsDBSender:model.isSender];
    }
    /** 红包消息不显示已读 */
    _hasRead.hidden = YES;
    /** 不显示姓名 */
