...
- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler {
    ...
    if(!self.pullToRefreshView) {
        ...
        view.arrowColor=[UIColor grayColor];
        view.titleLabel.text=@"正在刷新";
        
        [view setTitle:@"松开立即刷新" forState:SVPullToRefreshStateTriggered];
        [view setTitle:@"下拉可以刷新" forState:SVPullToRefreshStateStopped];
        [view setTitle:@"正在刷新数据中..." forState:SVPullToRefreshStateLoading];
