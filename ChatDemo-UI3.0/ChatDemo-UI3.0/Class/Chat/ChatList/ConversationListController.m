...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(DBrefreshData) name:@"DBrefreshData" object:nil];
}
                                    ...
                                    modelForConversation:(EMConversation *)conversation
{
    ...
    if (model.conversation.type == EMConversationTypeChat) {
        ...
        imageName = [[ext objectForKey:@"isPublic"] boolValue] ? @"dbgroup" : @"dbgroup";
