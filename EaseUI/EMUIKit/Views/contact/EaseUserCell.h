...
#define EaseCellHeight 60
static CGFloat EaseUserCellMinHeight = EaseCellHeight;
...
@property (nonatomic, copy) void(^stealRedBagBlock)();

//进度条
@property (nonatomic, copy) void(^progressViewBlock)();
