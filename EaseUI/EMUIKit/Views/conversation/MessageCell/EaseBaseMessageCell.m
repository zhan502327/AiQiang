...
//    _nameLabel.text = model.nickname;
    ...
    if (model.message.ext[FromHeading]) {
        [self.avatarView sd_setImageWithURL:[NSURL URLWithString:model.message.ext[FromHeading]] placeholderImage:model.avatarImage];
    }else{
        self.avatarView.image = model.avatarImage;
    }
...
- (void)setDic:(NSDictionary *)dic{
    [self.avatarView sd_setImageWithURL:[NSURL URLWithString:dic[FromHeading]] placeholderImage:nil];
    _nameLabel.text = dic[FromNickName];
}
